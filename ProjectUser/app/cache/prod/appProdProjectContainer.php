...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_a5f98065c9901a90b0d67a3ac41fabac');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_a5f98065c9901a90b0d67a3ac41fabac');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_a5f98065c9901a90b0d67a3ac41fabac');
        ...
        $d->setProxyDir('C:/Apache24/htdocs/workspace/ProjectUser/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:/Apache24/htdocs/workspace/ProjectUser/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('C:/Apache24/htdocs/workspace/ProjectUser/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('C:/Apache24/htdocs/workspace/ProjectUser/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('C:/Apache24/htdocs/workspace/ProjectUser/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'C:/Apache24/htdocs/workspace/ProjectUser/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'C:/Apache24/htdocs/workspace/ProjectUser/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:/Apache24/htdocs/workspace/ProjectUser/app/cache/prod',
            ...
            'session.save_path' => 'C:/Apache24/htdocs/workspace/ProjectUser/app/cache/prod/sessions',
            ...
            'router.resource' => 'C:/Apache24/htdocs/workspace/ProjectUser/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:/Apache24/htdocs/workspace/ProjectUser/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => 'C:/Apache24/htdocs/workspace/ProjectUser/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => 'C:/Apache24/htdocs/workspace/ProjectUser/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => 'C:/Apache24/htdocs/workspace/ProjectUser/app/cache/prod/doctrine/orm/Proxies',
